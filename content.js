...
function createSummaryPopup() {
  ...
  popup.innerHTML = `
    <div class="lc-popup-inner">
      <div class="lc-popup-header">
        <span class="lc-popup-logo"> LEETST★R</span>
  ...
  popup.querySelector('#lc-toggle-ds-btn').addEventListener('click', () => {
    ...
    popup.querySelector('#lc-toggle-ds-btn').innerHTML = dsVisible ? `${closedEye} Hide Data Structure` : `${openEye} Show Data Structure`;
  });
  ...
  popup.querySelector('#lc-toggle-practice-btn').addEventListener('click', () => {
    ...
    popup.querySelector('#lc-toggle-practice-btn').innerHTML = practiceVisible ? `${closedEye} Hide Practice First` : `${openEye} Show Practice First`;
  });
